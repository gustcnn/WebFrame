...
from com.mini.dynamic import decorate_frame_pseudo_static
    ...
    def service_client(self, request_socket):
        ...
        if len(recv_data_list) != 0:
            ...
            if re_html_result:
                ...
                # 判断文件名是否以.html结尾,不是返回静态资源(js,css,jpg),是返回动态页面
                if not file_name.endswith(".html"):
                    ...
                    response_body = decorate_frame_pseudo_static.application(response_dict, self.set_response_body)
